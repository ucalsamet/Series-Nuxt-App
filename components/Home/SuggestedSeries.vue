<template>
  <div>
    <b-row>
      <b-col md="3" v-for="serie in series.slice(0, 4)|| ''" :key="serie._id">
        <div
    ...
    <b-row class="mt-2">
      <b-col md="3" v-for="serie in series.slice(4, 8)|| ''" :key="serie._id">
        <div
          style="width: 260px; height: 120px; background-color:  #000000;"
          class="position-relative"
        >
