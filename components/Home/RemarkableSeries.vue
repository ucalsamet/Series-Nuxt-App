<template>
  <div class="d-flex flex-row">
    <div
      ...
      :key="serie._id"
    >
      <b-link :to="'/categories/' + serie._id">
        <b-img
          v-bind="mainProps"
        ...
        <div
          ...
          style="background-color:  #000000; width: 200px; height: 60px; top:230px; opacity: 0.7;word-wrap:break-word;"
        >
          ...
          <div class="d-flex flex-row ml-3 mt-2">
            ...
            <span class="score ml-2 mb-1">{{ serie.imdb }}/10</span>
            <div class="ml-auto d-flex flex-row">
              <span class="year mr-1">{{ serie.year }}</span>
            </div>
            <b-icon
...
export default {
  ...
  computed: {
    series() {
      ...
      let remarkableSeries = [];
      series.forEach(i => {
        if (i.category === "4") {
          remarkableSeries.push(i);
        }
      });
      return remarkableSeries;
    }
  }
};
</script>
